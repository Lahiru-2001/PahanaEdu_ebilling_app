<%@ page import="java.util.*, com.DAO.ItemDAO, com.DAO.ItemDAOImple, com.DB.DBConnecter, com.entity.Item" %>
                                        ...
                                        <c:when test="${not empty items}">
                                            <c:forEach var="item" items="${items}">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <img src="${pageContext.request.contextPath}/${item.image}" style="width: 60px; height: auto;" alt="Item Image"/>
                                                    </td>
                                                    <td>${item.status}</td>
                                                    <td>
                                                       <a href="load_item?item_id=${item.item_id}" class="btn btn-sm btn-warning">Edit</a>



                                                        <a href="delete_item?item_id=${item.item_id}" class="btn btn-sm btn-danger"
