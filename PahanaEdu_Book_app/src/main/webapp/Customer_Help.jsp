								...
								<div class="card" id="welcom_card">
									<div class="card-body">
										...
										<p class="card-text mt-3">
											Need help with your experience? Submit your issue using the form, 
											and we'll get back to you shortly. We're here to assist with:
										</p>
										<!-- List of common support topics -->
										<ul>
											<li>Orders</li>
											<li>Account Access</li>
											<li>Technical Issues</li>
											<li>Orders Process</li>
										</ul>
							...
							<div class="col-md-6">
								<div class="card" id="help_card">
									<div class="card-body">
										...
										<%
										// Display success or failure messages stored in session
										...
										<%
											session.removeAttribute("failedMsg"); // Remove after displaying
										}
										%>
										...
										<form action="customer_help" method="post">
											<div class="mb-3">
												<label for="title" class="form-label">Help Title</label>
											...
											<div class="mb-3">
												...
												<textarea class="form-control" id="message" name="message" rows="5"
													required placeholder="Describe your issue or question..."></textarea>
											</div>
											<!-- Submit button -->
