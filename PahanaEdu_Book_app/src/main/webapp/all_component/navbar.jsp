	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse justify-content-end"
			...
			<form class="d-flex align-items-center me-3" role="search"
				...
				<label for="nav-search" class="visually-hidden">Search</label> <input
					id="nav-search" class="form-control me-2" type="search"
	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse" id="adminNavbar">
			...
			<ul class="navbar-nav me-auto mb-2 mb-lg-0">
				<li class="nav-item"><a
					class="nav-link <!-- add 'active' server-side when on dashboard -->"
					href="Admin_Home.jsp" aria-current="page"><i
			...
			<div class="d-flex align-items-center gap-3">
				<!-- Notifications -->
				<div class="dropdown">
					<button class="btn position-relative text-white" id="notifDropdown"
						data-bs-toggle="dropdown" aria-expanded="false"
						aria-label="Notifications">
						<i class="fa-regular fa-bell fa-lg"></i> <span
							class="badge bg-danger rounded-pill badge-notification">3</span>
						<span class="visually-hidden">3 new notifications</span>
					</button>
					<ul class="dropdown-menu dropdown-menu-end"
						aria-labelledby="notifDropdown" style="width: 300px;">
						<li class="dropdown-header">Notifications</li>
						<li><hr class="dropdown-divider"></li>
						<li><a class="dropdown-item d-flex align-items-start"
							href="#">
								<div class="me-2">
						...
						<li><a class="dropdown-item text-center" href="#">View
								all</a></li>
					</ul>
				</div>
          ...
          <i class="fa-solid fa-moon" id="themeIcon"></i>
				...
				<div class="dropdown">
					<button class="btn d-flex align-items-center text-white"
						...
						<span class="me-1"><%=loggedUser.getUsername()%></span> <i
							class="fa-solid fa-chevron-down small"></i>
					</button>
					<ul class="dropdown-menu dropdown-menu-end"
						aria-labelledby="userMenu">
						<li><a class="dropdown-item" href="Admin_Manage_Users.jsp"><i
								class="fa-regular fa-user"></i> Manage Users</a></li>
						<li><a class="dropdown-item" href="Admin_help.jsp"><i
								class="fa-regular fa-headset"></i> Help</a></li>
						<li><hr class="dropdown-divider"></li>
		...
		<div class="collapse navbar-collapse" id="customerNavbar">
			...
			<ul class="navbar-nav me-auto mb-2 mb-lg-0">
				<li class="nav-item"><a class="nav-link active"
					aria-current="page" href="Customer_Home.jsp">Home</a></li>
				<li class="nav-item dropdown"><a
				...
				<li class="nav-item"><a class="nav-link" href="orders.jsp">My
						Orders</a></li>
				<li class="nav-item"><a class="nav-link" href="Customer_Help.jsp">Support</a>
				</li>
			</ul>
			...
			<form class="d-flex mx-lg-3 my-2 my-lg-0" role="search"
				...
				<div class="input-group">
					<input class="form-control" type="search"
						placeholder="Search courses, books..." aria-label="Search">
				...
				<li class="nav-item dropdown">
					<button class="btn d-flex align-items-center" id="userDropdown"
						...
						<i class="fa-solid fa-user-circle fa-2x me-1"></i> <span
							class="d-none d-md-inline"><%=loggedUser.getUsername()%></span> <i
							class="fa-solid fa-caret-down ms-1"></i>
					</button>
					<ul class="dropdown-menu dropdown-menu-end"
						aria-labelledby="userDropdown">
